...
const MyBookmarks = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white px-4">
      <h1 className="text-4xl font-bold text-white text-center py-12 tracking-tight">
        🔖 My Bookmarks
      </h1>
      ...
      {loading ? (
        ...
        <div className="grid gap-8 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 place-items-center pb-16">
